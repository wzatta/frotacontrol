...
public class FuncionarioMapper {
	...
	public Funcionario toEntity(FuncionarioRequestDto request) {
		...
		funcionario.setAtivo(request.getAtivo() == null ? true : request.getAtivo());
	...
	public Funcionario toEntityByCep(FuncionarioRquestByCepDto request) {
	...
	public void updateEntity(Funcionario funcionario, FuncionarioRequestUpdateDto request) {
